...
Additional Function: Piexl Level Label 
- Use A/I/E to transform the Click Mode into Auto Mode, Paint Mode, Erase Mode
- In the Paint/Erase Mode 
    - use -/= to change the size of painter 
    - use 0 to get into magnify mode
    - use [ or ] to change the boundary of magnify glass
